...
if __name__ == "__main__":
    resume = """
    Python developer with experience in FastAPI, Docker, and REST APIs.
    Worked on CI/CD pipelines and cloud deployment.
    """

    skills = ["Python", "FastAPI", "Docker", "SQL"]
    experience = ["CI/CD", "cloud", "deployment"]

    result = compute_resume_score(resume, skills, experience)
    print(result)